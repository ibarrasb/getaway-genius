        ...
        if (isLogged) {
            ...
            return (
                <div className="login-page">
                        ...
                        Simply input your travel details—like the dates, flight options, lodging, and more—and our app will organize and compare your choices based on price. This allows you to easily see price differences between trips/locations/dates, so you can decide the most cost-effective time to embark on your adventure.
                        
                        With Getaway Genius, you'll always know which trip works best for your budget. Ready to explore smarter? Start planning with us today!</h4>
                        <div className="row">
